...
- The campaign is a ten-mission alternate history set during the 1982 Falklands War.
...
| Mission number | Working title | Date | Location | Strategic event | Player role | Enemy role | Resupply status | New unit tier | Narrative consequence | Mechanical distinction | Status |
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | TBD | 1982, exact date TBD | Approaches to Cuba, exact area TBD | USSR attempts to move strategic missile systems into Cuba to distract and delay US intervention in the South Atlantic | A small US naval task force intercepts the Soviet convoy below the threshold of full US-Soviet war | Soviet convoy and escorts attempt to reach Cuba | TBD | Tier 0 — short notice; no carrier | Establishes the political crisis and Soviet diversion | Identification/ROE and convoy interception; exact design pending | Concept approved; not implemented |
| 2 | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD |
| 3 | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD |
| 4 | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD |
| 5 | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD |
| 6 | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD |
| 7 | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD |
| 8 | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD |
| 9 | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD |
| 10 | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD |
...
| 2–10 | TBD | TBD | TBD | TBD | TBD | TBD | TBD |
